...
export interface WidgetStyleOverrides { showLegend?: boolean; showGridlines?: boolean; strokeWidth?: number; opacity?: number; }
...
export interface DashboardGridItem { widgetId: string; x: number; y: number; w: number; h: number; minW?: number; minH?: number; static?: boolean; }
