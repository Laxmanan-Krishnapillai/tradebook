...
/**
 * Tradebook's installed relation picker. Its composition follows coss ui's Base UI
 * combobox pattern, reduced to the token-locked surface that record forms require.
 */
