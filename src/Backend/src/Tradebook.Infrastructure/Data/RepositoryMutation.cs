...
internal static class RepositoryMutation
{
        ...
        CancellationToken ct)
    {
        if (!OutboxAggregateTypes.IsKnown(aggregateType))
            throw new ArgumentOutOfRangeException(nameof(aggregateType), aggregateType, "Unknown outbox aggregate type.");
        ...
        return connection.ExecuteAsync(new CommandDefinition("""
            ...
            VALUES (
                ...
                jsonb_strip_nulls(jsonb_build_object(
                    ...
                    'version', @Version,
                    'reason', @Reason)))
            """, new { AggregateType = aggregateType, AggregateId = aggregateId, EventType = eventType, Version = version, Reason = reason },
