...
public sealed class GooCertificateRepository(INpgsqlConnectionFactory connections)
            ...
            await using (transaction.ConfigureAwait(false))
            {
                ...
                await (
                    RepositoryMutation.WriteOutboxAsync(
                        ...
                        created.GooCertificateTransactionId.ToString(),
                        "Created",
                        created.Version,
                        null,
                        ct
            ...
            await using (transaction.ConfigureAwait(false))
            {
                ...
                await (
                    RepositoryMutation.WriteOutboxAsync(
                        ...
                        transaction,
                        OutboxAggregateTypes.GooCertificateTransaction,
                        updated.GooCertificateTransactionId.ToString(),
                        "Updated",
                        updated.Version,
                        null,
                        ct
