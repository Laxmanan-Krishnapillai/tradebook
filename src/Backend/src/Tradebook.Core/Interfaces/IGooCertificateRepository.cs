...
public interface IGooCertificateRepository
{
    ...
    Task<GetGooCertificateHistoryResponse> GetHistoryAsync(
        GetGooCertificateHistoryRequest request,
        CancellationToken ct
    );
    Task<GooCertificateTransactionDetailsDto> CreateAtomicAsync(
        CreateGooCertificateTransactionRequest request,
        Guid actorId,
        CancellationToken ct
    );
    Task<GooCertificateTransactionDetailsDto?> UpdateAtomicAsync(
        UpdateGooCertificateTransactionRequest request,
        Guid actorId,
        CancellationToken ct
    );
    Task<GooCertificateTransactionDetailsDto?> RequestBatchExportAtomicAsync(
        Guid id,
        long version,
        Guid actorId,
        CancellationToken ct
