...
public static class AuthenticationServiceCollectionExtensions
{
    ...
    )
    {
        ...
        services.AddSingleton<IValidateOptions<JwtOptions>, JwtSecurityOptionsValidator>();
        services
        ...
        services.AddAuthorization(options =>
        {
            ...
            options.AddPolicy(
                "ReadPolicy",
                policy => policy.RequireRole("Trader", "BackOffice", "Admin")
            );
            options.AddPolicy("TraderPolicy", policy => policy.RequireRole("Trader", "Admin"));
            options.AddPolicy(
                "BackOfficePolicy",
                policy => policy.RequireRole("BackOffice", "Admin")
            );
    ...
    private static void ConfigureJwtBearer(JwtBearerOptions bearer, IOptions<JwtOptions> configured)
    {
